...
=======
    ...
    public ResponseEntity addOrder(@RequestBody Order order){
        orderService.addOrder(order);
        return new ResponseEntity<>("Order added Succesfully", HttpStatus.CREATED);
    }

    @PostMapping("/add-partner/{partnerId}")
    public ResponseEntity addPartner(@PathVariable String partnerId){
>>>>>>> b296849 (Amazoff Complete new)
